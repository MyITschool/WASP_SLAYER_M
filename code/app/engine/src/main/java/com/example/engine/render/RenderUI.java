...
//    private float[] objectSize=new float[]{1,1,1};
    ...
    private Vector4 mColor=new Vector4(1);
...
//    private int[] res = new int[]{0,0};
    ...
    private float[] material = new float[]{-1};

    private boolean objUpd = false;

    private final int[] shader_vars;
    private final int[] mVBOIds;
    private final int[] uUIMaterial;
    
    public RenderUI(int[] shader_vars, int[] mVBOIds, int[] uUIMaterial) {
